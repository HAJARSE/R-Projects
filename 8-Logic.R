...
...
  ...
  |====                                                                                                           |   4%
| Many of the questions in this lesson will involve evaluating logical expressions. It may be useful to open up a second
| R terminal where you can experiment with some of these expressions.
...
| Excellent work!
  ...
  |==============================                                                                                 |  27%
| In order to negate boolean expressions you can use the NOT operator. An exclamation point `!` will cause !TRUE (say:
| not true) to evaluate to FALSE and !FALSE (say: not false) to evaluate to TRUE. Try using the NOT operator and the
